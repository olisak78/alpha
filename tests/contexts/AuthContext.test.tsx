...
describe('AuthContext', () => {
  ...
  describe('AuthProvider Initialization', () => {
    ...
    it('should set user when githubtools is valid but isAuthenticated false when both auths not complete', async () => {
      ...
      expect(screen.getByTestId('user')).toHaveTextContent('Test User'); // User is set because GitHub Tools is authenticated
      expect(screen.getByTestId('isAuthenticated')).toHaveTextContent('false'); // But not fully authenticated
    });
    ...
    it('should fetch user when githubtools is authenticated even if wdf is not', async () => {
      vi.mocked(authService.checkDualAuthStatus).mockResolvedValue({
        githubtools: true,
        githubwdf: false,
      });
      ...
      expect(screen.getByTestId('user')).toHaveTextContent('Test User');
      expect(screen.getByTestId('isAuthenticated')).toHaveTextContent('false'); // Still false because isBothAuthenticated returns false
    });
