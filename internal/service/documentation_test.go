...
func (suite *DocumentationServiceTestSuite) TestCreateDocumentation_Success_FullGitHubURL() {
	...
	suite.mockAuthService.EXPECT().
		GetAllProviders().
		Return(map[string]string{"github.tools.sap": "https://github.tools.sap"}).
		Times(1)
	...
	suite.Equal("github.tools.sap", result.Provider)
...
func (suite *DocumentationServiceTestSuite) TestCreateDocumentation_Success_GitHubComURL() {
	...
	suite.Equal("github.com", result.Provider)
}
...
// Test provider validation in parseGitHubURL
func (suite *DocumentationServiceTestSuite) TestCreateDocumentation_Success_WithConfiguredProvider_GitHubTools() {
	req := &service.CreateDocumentationRequest{
		TeamID:      suite.testTeamID.String(),
		URL:         "https://github.tools.sap/org/repo",
		Title:       "Test Doc",
		Description: "Test with github.tools.sap provider",
		CreatedBy:   "test-user",
	}

	suite.mockAuthService.EXPECT().
		GetAllProviders().
		Return(map[string]string{"github.tools.sap": "https://github.tools.sap", "github.wdf.sap.corp": "https://github.wdf.sap.corp"}).
		Times(1)
	...
	suite.mockDocRepo.EXPECT().
		...
		DoAndReturn(func(doc *models.Documentation) error {
			...
			suite.Equal("github.tools.sap", doc.Provider)
			suite.Equal("org", doc.Owner)
			suite.Equal("repo", doc.Repo)
			doc.ID = uuid.New()
			return nil
		}).
		Times(1)
...
func (suite *DocumentationServiceTestSuite) TestCreateDocumentation_Success_WithConfiguredProvider_GitHubWDF() {
	req := &service.CreateDocumentationRequest{
		TeamID:      suite.testTeamID.String(),
		URL:         "https://github.wdf.sap.corp/myorg/myrepo/tree/main/docs",
		Title:       "WDF Documentation",
		Description: "Test with github.wdf.sap.corp provider",
		CreatedBy:   "test-user",
	}
	...
	suite.mockDocRepo.EXPECT().
		Create(gomock.Any()).
		DoAndReturn(func(doc *models.Documentation) error {
			// Verify the provider is correctly set to github.wdf.sap.corp
			suite.Equal("github.wdf.sap.corp", doc.Provider)
			suite.Equal("myorg", doc.Owner)
			suite.Equal("myrepo", doc.Repo)
			suite.Equal("main", doc.Branch)
			suite.Equal("docs", doc.DocsPath)
			doc.ID = uuid.New()
			return nil
		}).
		Times(1)
...
func (suite *DocumentationServiceTestSuite) TestCreateDocumentation_Success_WithDefaultProvider_GitHubCom() {
	req := &service.CreateDocumentationRequest{
		TeamID:      suite.testTeamID.String(),
		URL:         "https://github.com/kubernetes/kubernetes",
		Title:       "Kubernetes Docs",
		Description: "Test with github.com (default provider)",
		CreatedBy:   "test-user",
	}
	...
	suite.mockDocRepo.EXPECT().
		Create(gomock.Any()).
		DoAndReturn(func(doc *models.Documentation) error {
			// Verify github.com is accepted as default provider
			suite.Equal("github.com", doc.Provider)
			suite.Equal("kubernetes", doc.Owner)
			suite.Equal("kubernetes", doc.Repo)
			doc.ID = uuid.New()
			return nil
		}).
		Times(1)
...
func (suite *DocumentationServiceTestSuite) TestCreateDocumentation_Error_UnsupportedProvider() {
	req := &service.CreateDocumentationRequest{
		TeamID:      suite.testTeamID.String(),
		URL:         "https://gitlab.com/org/repo",
		Title:       "GitLab Doc",
		Description: "Test with unsupported provider",
		CreatedBy:   "test-user",
	}
	...
	suite.Nil(result)
	suite.Contains(err.Error(), "invalid GitHub URL")
	suite.Contains(err.Error(), "invalid GitHub host")
}

func (suite *DocumentationServiceTestSuite) TestUpdateDocumentation_Success_ChangeProvider() {
	docID := uuid.New()
	existingDoc := &models.Documentation{
		TeamID:      suite.testTeamID,
		Owner:       "old-owner",
	...
	newURL := "https://github.wdf.sap.corp/new-owner/new-repo/tree/main/docs"
	req := &service.UpdateDocumentationRequest{
		URL:       &newURL,
		UpdatedBy: "updater",
	}
...
func (suite *DocumentationServiceTestSuite) TestUpdateDocumentation_Error_ChangeToUnsupportedProvider() {
	docID := uuid.New()
	existingDoc := &models.Documentation{
		TeamID:    suite.testTeamID,
		Owner:     "owner",
	...
	// Try to update to unsupported provider
	invalidURL := "https://gitlab.com/owner/repo"
	req := &service.UpdateDocumentationRequest{
		URL:       &invalidURL,
		UpdatedBy: "updater",
