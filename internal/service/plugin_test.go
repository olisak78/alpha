...
func (m *MockGitHubService) GetUserTotalContributions(ctx context.Context, uuid string) (*TotalContributionsResponse, error) {
...
func (m *MockGitHubService) GetAveragePRMergeTime(ctx context.Context, uuid, period string) (*AveragePRMergeTimeResponse, error) {
...
func (m *MockGitHubService) GetUserPRReviewComments(ctx context.Context, uuid, period string) (*PRReviewCommentsResponse, error) {
	args := m.Called(ctx, uuid, period)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
