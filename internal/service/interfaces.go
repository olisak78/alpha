...
type GitHubServiceInterface interface {
	...
	GetUserTotalContributions(ctx context.Context, uuid string) (*TotalContributionsResponse, error)
	GetAveragePRMergeTime(ctx context.Context, uuid, period string) (*AveragePRMergeTimeResponse, error)
	GetUserPRReviewComments(ctx context.Context, uuid, period string) (*PRReviewCommentsResponse, error)
	...
	DeleteRepositoryFile(ctx context.Context, uuid, provider, owner, repo, path, message, sha, branch string) (interface{}, error)
	DeleteRepositoryFolder(ctx context.Context, uuid, provider, owner, repo, path, message, branch string) (interface{}, error)
...
type JenkinsServiceInterface interface {
	...
	GetConcourseLatestExecution(ctx context.Context) (int, error)
	GetConcourseJobs(ctx context.Context, buildNumber int, landscape string) (interface{}, error)
}
