...
type Config struct {
	...
	// Alert Storage Service configuration
	AlertStorageServiceUrl string `mapstructure:"ALERT_STORAGE_SERVICE_URL"`
}
...
func setDefaults() {
	...
	// Alert Storage Service defaults
	viper.SetDefault("ALERT_STORAGE_SERVICE_URL", "http://localhost:8085")
}
