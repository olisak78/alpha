...
func (m *MockGitHubService) GetUserTotalContributions(ctx context.Context, uuid string) (*service.TotalContributionsResponse, error) {
...
func (m *MockGitHubService) GetAveragePRMergeTime(ctx context.Context, uuid, period string) (*service.AveragePRMergeTimeResponse, error) {
	args := m.Called(ctx, uuid, period)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *MockGitHubService) GetUserPRReviewComments(ctx context.Context, uuid, period string) (*service.PRReviewCommentsResponse, error) {
	args := m.Called(ctx, uuid, period)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *MockGitHubService) DeleteRepositoryFile(ctx context.Context, uuid, provider, owner, repo, path, message, sha, branch string) (interface{}, error) {
	args := m.Called(ctx, uuid, provider, owner, repo, path, message, sha, branch)
	return args.Get(0), args.Error(1)
}

func (m *MockGitHubService) DeleteRepositoryFolder(ctx context.Context, uuid, provider, owner, repo, path, message, branch string) (interface{}, error) {
	args := m.Called(ctx, uuid, provider, owner, repo, path, message, branch)
	return args.Get(0), args.Error(1)
}
