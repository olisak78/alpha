...
func (m *MockProjectRepositoryInterface) GetHealthMetadata(projectID uuid.UUID) (string, string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockProjectRepositoryInterfaceMockRecorder) GetHealthMetadata(projectID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetHealthMetadata", reflect.TypeOf((*MockProjectRepositoryInterface)(nil).GetHealthMetadata), projectID)
}
...
// GetComponentsByProjectID mocks base method.
func (m *MockComponentRepositoryInterface) GetComponentsByProjectID(projectID uuid.UUID, limit, offset int) ([]models.Component, int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetComponentsByProjectID", projectID, limit, offset)
	ret0, _ := ret[0].([]models.Component)
	ret1, _ := ret[1].(int64)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
...
// GetComponentsByProjectID indicates an expected call of GetComponentsByProjectID.
func (mr *MockComponentRepositoryInterfaceMockRecorder) GetComponentsByProjectID(projectID, limit, offset any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetComponentsByProjectID", reflect.TypeOf((*MockComponentRepositoryInterface)(nil).GetComponentsByProjectID), projectID, limit, offset)
}
