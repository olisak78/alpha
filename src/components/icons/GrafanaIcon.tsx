...
export const GrafanaIcon: React.FC<GrafanaIconProps> = ({ className = "h-4 w-4" }) => {
  return (
    <svg
      className={className}
      viewBox="0 0 351 365"
    ...
    >
      <defs>
        <linearGradient id="grafana-gradient" x1="175.5" y1="30%" x2="175.5" y2="99%">
          <stop offset="0" style={{ stopColor: '#F05A28' }} />
          <stop offset="1" style={{ stopColor: '#FBCA0A' }} />
        </linearGradient>
      </defs>
      <path
        fill="url(#grafana-gradient)"
